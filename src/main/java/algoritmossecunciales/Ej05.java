...
public class Ej05 {
    ...
    public static void main(String[] args) {
        ...
        int horasProfesor;//variable para dividir las horasPro/ cantidaGrupos
        int numeroProfesores;//resultado del algoritmo
        ...
        System.out.println("Se necesitaran "+ numeroProfesores+ " profesores");
